...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, SquareHeadLoss, ClipSoftLoss
...
def load_checkpoint(model, checkpoint_path, strict=True):
    ...
    state_dict=convert_to_mha_prune_state_dict(state_dict)
